...
# # Where are we?
# # We have a proc in core.rb being set that calls a function we define there
# # need to find out how to get the proc to activate on a timeout. working theory: /lib/rex/ui/text/dispatcher_shell.rb:530
# # investigate on_command_proc from dispatcher shell
# # self.client.on_error_proc
